<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="市场价格" min-width="150px">
        <template slot-scope="{row}">
          <span class="link-type" @click="handleUpdate(row)">{{ row.title }}</span>
          <el-tag>{{ row.type | typeFilter }}</el-tag>
        </template>
      </el-table-column>
      <el-table-column label="门店价格" width="110px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.author }}</span>
        </template>
      </el-table-column>
      <el-table-column v-if="是否推荐" label="Reviewer" width="110px" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="是否上架" align="center" width="95">
        <template slot-scope="{row}">
          <span v-if="row.pageviews" class="link-type" @click="handleFetchPv(row.pageviews)">{{ row.pageviews }}</span>
          <span v-else>0</span>
        </template>
      </el-table-column>
      <el-table-column label="关键字" class-name="status-col" width="100">
                ...
                <el-row class="demo-avatar demo-basic">
                  <el-col :span="12">
                    ...
                    <div class="demo-basic--circle">
                      ...
                      <div class="block" v-for="size in UrlList" :key="size">
