 ...
 * @description: 预约确认通知
 * @author: chenyixin
 * @create: 2019-09-23 14:35
 **/
@Slf4j
@Component
public class AppointmentConfirmProcessor implements MessageProcessor<MyMessage>{
    @Resource
    ...
    public boolean handle(MyMessage message) {
        ...
        eventHandler.pushCustomerAppointmentConfirmMsg(appointment);
        log.info("客户端推送预约确认消息成功");
