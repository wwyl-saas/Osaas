...
import com.fate.api.customer.event.*;
...
public class MsgEventListener {
    ...
    public void wxPublicListener(PublicMsgEvent event) {
        try {
            ...
            WxMpService wxMpService = WxMpConfiguration.getMpService(event.getAppid());
    ...
    public void wxAppletListener(WxAppletMsgEvent event) {
        try {
            ...
            WxMaService wxMaService = WxMaConfiguration.getMaService(event.getAppid());
