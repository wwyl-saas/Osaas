package com.fate.api.customer.config.swagger;
...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        ...
        ticketPar1.name("applicationId").description("后端分配给前端应用（小程序/H5/公众号）的ID")
        ...
        return new Docket(DocumentationType.SWAGGER_2).globalOperationParameters(pars)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.fate.api.customer.controller"))
