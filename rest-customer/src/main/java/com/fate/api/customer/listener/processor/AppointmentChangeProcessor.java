...
@Slf4j
@Component
public class AppointmentChangeProcessor implements MessageProcessor<MyMessage>{
    @Resource
    ...
    public boolean handle(MyMessage message) {
        ...
        eventHandler.pushCustomerAppointmentChangeMsg(appointment);
        log.info("客户端推送预约改约消息成功");
