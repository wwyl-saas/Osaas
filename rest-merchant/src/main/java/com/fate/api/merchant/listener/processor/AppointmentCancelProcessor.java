...
public class AppointmentCancelProcessor implements MessageProcessor<MyMessage>{
    ...
    public boolean handle(MyMessage message) {
        ...
        wxPublicEvent.setTemplateId(PublicTemplate.APPOINTMENT_CANCEL_TEMPLATE_ID);
        //预约技师
        ...
        templateData.add(new WxMpTemplateData("first", String.format("您有一个%s的预约已被客户取消",appointment.getShopName())));
        ...
        templateData.add(new WxMpTemplateData("remark", "点击下方进入商户端小程序进行查看"));
